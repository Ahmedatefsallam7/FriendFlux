<div wire:poll>
    ...
    <div style="display:block" id="create-post" class="alert alert-success">
        {{ session()->get('notify') }}
    </div>
    @endif
    <div class="card w-100 shadow-xss rounded-xxl border-0 pe-4 pt-4 ps-4 pb-3 mb-3">
        ...
        <div class="card-body p-0">
            <p class="font-xssss fw-600 text-blue card-body p-0 d-flex align-items-center"><span style="color:blue;margin-top:-3px;margin-left:5px"><?php echo $icons->getIcon('edit'); ?></span>Create
                Post</p>
        </div>
        ...
        <div class="card-body d-flex p-0 mt-0">
            ...
            <button wire:click.prevent='storePost' title="add new post" onclick="window.scrollTo(0,0)" style="background-color:rgb(86, 74, 243)" class="me-auto btn text-white rounded-circle"><span style="margin-top:-7px ;margin-left:2px"><?php echo $icons->getIcon('send'); ?></span></button>

        </div>

    </div>
    <script>
        const x = document.getElementById('create-post');
        setTimeout(() => {

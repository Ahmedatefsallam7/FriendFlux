...
<div class="row feed-body">
    <div class="col-xl-8 col-xxl-9 col-lg-8">
        <div class="card w-100 shadow-none bg-transparent bg-transparent-card border-0 p-0 mb-0">
            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                        ...
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-11.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                ...
                <div class="item">
                    <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-2.jpg);">
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-12.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                    Surfiya Zakir </h4>
                ...
                <div class="item">
                    <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3">
                        ...
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-9.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                    Goria Coast </h4>
                ...
                <div class="item">
                    <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3 ms-1">
                        <video autoplay loop class="float-right w-100">
                        ...
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-4.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                    Hurin Seary </h4>
                ...
                <div class="item">
                    <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-5.jpg);">
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-3.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                    David Goria </h4>
                ...
                <div class="item">
                    <div data-bs-toggle="modal" data-bs-target="#Modalstory" class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3" style="background-image: url(../images/s-6.jpg);">
                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                            <a href="#">
                                <figure class="avatar me-auto ms-auto mb-0 position-relative w50 z-index-1">
                                    <img src="../images/user-2.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                </figure>
                                <div class="clearfix"></div>
                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                    Seary Victor </h4>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 pe-4 pt-4 ps-4 pb-3 mb-3">
            <div class="card-body p-0">
                <a href="#" class=" font-xssss fw-600 text-grey-500 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary feather-edit-3 ms-2 bg-greylight"></i>Create
                    Post</a>
            </div>
            <div class="card-body p-0 mt-3 position-relative">
                <figure class="avatar position-absolute me-2 mt-1 top-5"><img src="../images/user-8.png" alt="image" class="shadow-sm rounded-circle w30">
                </figure>
                <textarea name="message" class="h100 bor-0 w-100 rounded-xxl p-2 pe-5 font-xssss text-grey-500 fw-500 border-light-md theme-dark-bg" cols="30" rows="10" placeholder="What's on your mind?"></textarea>
            </div>
            <div class="card-body d-flex p-0 mt-0">
                <a href="#" class="d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark ps-4"><i class="font-md text-danger feather-video ms-2"></i><span class="d-none-xs">Live Video</span></a>
                <a href="#" class="d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark ps-4"><i class="font-md text-success feather-image ms-2"></i><span class="d-none-xs">Photo/Video</span></a>
                <a href="#" class="d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark ps-4"><i class="font-md text-warning feather-camera ms-2"></i><span class="d-none-xs">Feeling/Activity</span></a>
                <a href="#" class="me-auto" id="dropdownMenu4" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
                <div class="dropdown-menu dropdown-menu-start p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu4">
                    <div class="card-body p-0 d-flex">
                        <i class="feather-bookmark text-grey-500 ms-3 font-lg"></i>
                        <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Save Link <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Add this
                                to your saved items</span></h4>
                    </div>
                    <div class="card-body p-0 d-flex mt-2">
                        <i class="feather-alert-circle text-grey-500 ms-3 font-lg"></i>
                        <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Hide Post <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to
                                your saved items</span></h4>
                    </div>
                    <div class="card-body p-0 d-flex mt-2">
                        <i class="feather-alert-octagon text-grey-500 ms-3 font-lg"></i>
                        <h4 class="fw-600 text-grey-900 font-xssss mt-0 ms-4">Hide all from Group
                            <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to
                                your saved items</span></h4>
                    </div>
                    <div class="card-body p-0 d-flex mt-2">
                        <i class="feather-lock text-grey-500 ms-3 font-lg"></i>
                        <h4 class="fw-600 mb-0 text-grey-900 font-xssss mt-0 ms-4">Unfollow Group
                            <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to
                                your saved items</span></h4>
                    </div>
                </div>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
            <div class="card-body p-0 d-flex">
                <figure class="avatar ms-3"><img src="../images/user-7.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Surfiya Zakir <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">3 hour ago</span>
                </h4>
                <a href="#" class="me-auto" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
            ...
            <div class="card-body p-0 ms-lg-5">
                <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">Lorem ipsum dolor sit amet,
                    ...
                    <a href="#" class="fw-600 text-primary me-2">See more</a></p>
            </div>
            <div class="card-body d-block p-0">
                <div class="row pe-2 ps-2">
                    ...
                    <div class="col-xs-4 col-sm-4 p-1"><a href="../images/t-12.jpg" data-lightbox="roadtrip" class="position-relative d-block"><img src="../images/t-12.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                    </div>
                </div>
            </div>
            <div class="card-body d-flex p-0 mt-3">
                <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss ms-2"><i class="feather-thumbs-up text-white bg-primary-gradiant ms-1 btn-round-xs font-xss"></i>
                    <i class="feather-heart text-white bg-red-gradiant ms-2 btn-round-xs font-xss"></i>2.8K
                    Like</a>
                ...
                <a href="#" id="dropdownMenu21" data-bs-toggle="dropdown" aria-expanded="false" class="me-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-share-2 text-grey-900 text-dark btn-round-sm font-lg"></i><span class="d-none-xs">Share</span></a>
                <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu21">
                    <h4 class="fw-700 font-xss text-grey-900 d-flex align-items-center">Share <i class="feather-x me-auto font-xssss btn-round-xs bg-greylight text-grey-900 ms-2"></i>
                    </h4>
                    <div class="card-body p-0 d-flex">
                    ...
                    <h4 class="fw-700 font-xssss mt-4 text-grey-500 d-flex align-items-center mb-3">
                        Copy Link</h4>
                    <i class="feather-copy position-absolute left-15 ms-4 mt-3 font-xs text-grey-500"></i>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
            <div class="card-body p-0 d-flex">
                <figure class="avatar ms-3 m-0"><img src="../images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Goria Coast <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">2 hour ago</span>
                </h4>
                <a href="#" class="me-auto" id="dropdownMenu6" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
            ...
            <div class="card-body d-flex p-0">
                ...
                <a href="#" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-message-circle text-dark text-grey-900 btn-round-sm font-lg"></i><span class="d-none-xss">22 Comment</span></a>
                <a href="#" id="dropdownMenu31" data-bs-toggle="dropdown" aria-expanded="false" class="me-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-share-2 text-grey-900 text-dark btn-round-sm font-lg"></i><span class="d-none-xs">Share</span></a>
        ...
        <div class="card w-100 shadow-none bg-transparent bg-transparent-card border-0 p-0 mb-0">
            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url(../images/u-bg.jpg);"></div>
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-11.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-2.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-3.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-4.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-7.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-5.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 ms-2 mt-3">
                        ...
                        <div class="card-body d-block w-100 pe-4 ps-4 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 mt--6 position-relative w75 z-index-1">
                                <img src="../images/user-6.png" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                            <div class="clearfix"></div>
                            <h4 class="fw-700 font-xsss mt-2 mb-1">Mohannad Zitoun </h4>
                            <p class="fw-500 font-xsssss text-grey-500 mt-0 mb-2">support@gmail.com
                            </p>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
            <div class="card-body p-0 d-flex">
                ...
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Anthony Daugloi <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">2 hour ago</span>
                </h4>
                <a href="#" class="me-auto" id="dropdownMenu5" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
            ...
            <div class="card-body p-0 ms-lg-5">
                <p class="fw-500 text-grey-500 lh-26 font-xssss w-100 mb-2">Lorem ipsum dolor sit
                    ...
                    rhoncus <a href="#" class="fw-600 text-primary me-2">See more</a></p>
            </div>
            <div class="card-body d-flex p-0">
                <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss ms-2"><i class="feather-thumbs-up text-white bg-primary-gradiant ms-1 btn-round-xs font-xss"></i>
                    <i class="feather-heart text-white bg-red-gradiant ms-2 btn-round-xs font-xss"></i>2.8K
                ...
                <a href="#" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-message-circle text-dark text-grey-900 btn-round-sm font-lg"></i><span class="d-none-xss">22 Comment</span></a>
                <a href="#" class="me-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-share-2 text-grey-900 text-dark btn-round-sm font-lg"></i><span class="d-none-xs">Share</span></a>
            </div>
        </div>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
            <div class="card-body p-0 d-flex">
                ...
                <a href="#" class="me-auto"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
            </div>
            ...
            <div class="card-body d-block p-0 mb-3">
                ...
                <div class="row pe-2 ps-2">
                    ...
                    <div class="col-xs-4 col-sm-4 p-1"><a href="../images/t-35.jpg" data-lightbox="roadtri" class="position-relative d-block"><img src="../images/t-25.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                    </div>
                </div>
            </div>
            <div class="card-body d-flex p-0">
        ...
        <div class="card w-100 shadow-none bg-transparent bg-transparent-card border-0 p-0 mb-0">
            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                <div class="item">
                    <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 ms-2 mt-3">
                        <div class="card-body d-block w-100 pe-3 ps-3 pb-4 text-center">
                            ...
                            <a href="#" class="text-center p-2 lh-20 w100 me-1 ls-3 d-inline-block rounded-xl bg-success font-xsssss fw-700 ls-lg text-white">FOLLOW</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                ...
                <div class="item">
                    <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 ms-2 mt-3">
                        <div class="card-body d-block w-100 pe-3 ps-3 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 position-relative w65 z-index-1">
                                <img src="../images/user-8.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                            </figure>
                            <div class="clearfix"></div>
                ...
                <div class="item">
                    <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 ms-2 mt-3">
                        <div class="card-body d-block w-100 pe-3 ps-3 pb-4 text-center">
                            <figure class="avatar me-auto ms-auto mb-0 position-relative w65 z-index-1">
                                <img src="../images/user-7.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                            </figure>
                            <div class="clearfix"></div>
    ...
    <div class="mt-0 col-xl-4 col-xxl-3 col-lg-4 pe-lg-0">

        {{-- start Friend Request --}}
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            <div class="card-body d-flex align-items-center p-4">
                <h4 class="fw-700 mb-0 font-xssss text-grey-900">Friend Request</h4>
                <a href="default-member.html" class="fw-600 me-auto font-xssss text-primary">See
                    all</a>
            </div>
            <div class="card-body d-flex pt-4 pe-4 ps-4 pb-0 border-top-xs bor-0">
                <figure class="avatar ms-3"><img src="../images/user-7.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Anthony Daugloi <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
            </div>
            <div class="card-body d-flex align-items-center pt-0 pe-4 ps-4 pb-4">
                <a href="#" class="p-2 lh-20 w100 bg-primary-gradiant ms-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Confirm</a>
                <a href="#" class="p-2 lh-20 w100 bg-grey text-grey-800 text-center font-xssss fw-600 ls-1 rounded-xl">Delete</a>
            </div>

            <div class="card-body d-flex pt-0 pe-4 ps-4 pb-0">
                <figure class="avatar ms-3"><img src="../images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Mohannad Zitoun <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
            </div>
            <div class="card-body d-flex align-items-center pt-0 pe-4 ps-4 pb-4">
                <a href="#" class="p-2 lh-20 w100 bg-primary-gradiant ms-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Confirm</a>
            ...
            <div class="card-body d-flex pt-0 pe-4 ps-4 pb-0">
                <figure class="avatar ms-3"><img src="../images/user-12.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Mohannad Zitoun <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
            </div>
            <div class="card-body d-flex align-items-center pt-0 pe-4 ps-4 pb-4">
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 p-0 ">
            ...
            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight me-3 ms-3 rounded-3">
                <figure class="avatar ms-2 mb-0"><img src="../images/user-7.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-2">Anthony Daugloi <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
                <a href="#" class="btn-round-sm bg-white text-grey-900 feather-chevron-right font-xss me-auto mt-2"></a>
            </div>
            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3" style="margin-bottom: 0 !important;">
                <figure class="avatar ms-2 mb-0"><img src="../images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-2"> David Agfree <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
                <a href="#" class="btn-round-sm bg-white text-grey-900 feather-plus font-xss me-auto mt-2"></a>
            </div>
            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3">
                <figure class="avatar ms-2 mb-0"><img src="../images/user-12.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                <h4 class="fw-700 text-grey-900 font-xssss mt-2">Hugury Daugloi <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual
                        friends</span></h4>
                <a href="#" class="btn-round-sm bg-white text-grey-900 feather-plus font-xss me-auto mt-2"></a>
            </div>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
            <div class="card-body d-flex align-items-center p-4">
                ...
                <a href="default-group.html" class="fw-600 me-auto font-xssss text-primary">See
                    all</a>
            </div>
            ...
            <div class="card-body dd-block pt-0 pe-4 ps-4 pb-4">
                <ul class="memberlist mt-1 mb-2 me-0 d-block">
                    ...
                    <li class="ps-3 w-auto me-1"><a href="#" class="fw-600 text-grey-500 font-xssss">Member apply</a></li>
                </ul>
            </div>
        </div>
        {{-- end Suggest Group --}}
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            ...
            <div class="card-body d-flex align-items-center pt-0 pe-4 ps-4 pb-4">
                <a href="#" class="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i class="feather-external-link font-xss ms-2"></i> Like Page</a>
            </div>
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            <div class="card-body d-flex align-items-center  p-4">
                ...
                <a href="default-event.html" class="fw-600 me-auto font-xssss text-primary">See
                    all</a>
            </div>
            <div class="card-body d-flex pt-0 pe-4 ps-4 pb-3 overflow-hidden">
                ...
                <h4 class="fw-700 text-grey-900 font-xssss mt-2">Meeting with clients <span class="d-block font-xsssss fw-500 mt-1 lh-4 text-grey-500">41 madison ave,
        ...
        <div class="modal-content border-0 bg-transparent">
            ...
            <div class="modal-body p-0">
                ...
                <div class="form-group mt-3 mb-0 p-3 position-absolute bottom-0 z-index-1 w-100">
                    <input type="text" class="style2-input w-100 bg-transparent border-light-md p-3 ps-5 font-xssss fw-500 text-white" value="Write Comments">
    ...
    <div class="modal-popup-wrap bg-white p-0 shadow-lg rounded-3">
        <div class="modal-popup-header w-100 border-bottom">
            <div class="card p-3 d-block border-0 d-block">
                <figure class="avatar mb-0 float-left ms-2">
                    <img src="../images/user-12.png" alt="image" class="w35 ms-1">
                </figure>
                ...
                <a href="#" class="font-xssss position-absolute right-0 top-0 mt-3 ms-4"><i class="ti-close text-grey-900 mt-2 d-inline-block"></i></a>
            </div>
        </div>
        <div class="modal-popup-body w-100 p-3 h-auto">
            ...
            <div class="snippet pt-3 pe-4 pb-2 ps-3 mt-2 bg-grey rounded-xl float-right" data-title=".dot-typing">
                <div class="stage">
                    <div class="dot-typing"></div>
                </div>
            </div>
        ...
        <div class="modal-popup-footer w-100 border-top">
            <div class="card p-3 d-block border-0 d-block">
                <div class="form-group icon-right-input style1-input mb-0"><input type="text" placeholder="Start typing.." class="form-control rounded-xl bg-greylight border-0 font-xssss fw-500 pe-3"><i class="feather-send text-grey-500 font-md"></i></div>
            </div>
        </div>
    </div>
</div> --}}
